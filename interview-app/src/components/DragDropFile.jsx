...
function DragDropFile() {
  ...
  return (
    ...
    <div className="flex justify-center items-center" style={{backgroundColor: "#EFEEEE", height: '75px', fontSize: '20px' }}>Interview Simulator</div>

    <form id="form-file-upload" style={{ width: '46%', margin: '30px' }} onDragEnter={handleDrag} onSubmit={(e) => e.preventDefault()}>    
